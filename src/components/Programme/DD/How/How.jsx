    ...
    <div className={styles.how}>
      ...
      <div className={styles.container}>
        ...
        <p>
          ...
          select “Donation Drive” and the inquiry box do provide details of the
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              {" "}
              <img src={check} alt='' />
              Provide any specific guidelines on the condition of items accepted
              (e.g., clean, in good repair).
            </li>
            <li>
              {" "}
              <img src={check} alt='' />
